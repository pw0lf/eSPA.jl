...
experiment_dir = "exp1_hybrid_$(d)_$(n)_" * timestamp
...
function train_and_eval_model(K, eps_CL, eps_E, tol, num_fuzzy_steps)
    ...
    start_time, start_optimization, start_fuzzy, end_time, opt_times_discr,
    opt_times_fuzzy = eSPA.fit!(model, X_train, y_train)
